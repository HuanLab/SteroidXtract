...
#########################################
# Working directories
input_dir = 'E:/SteroidXtract_2020/mzXML files' # input data path for SteroidXtract
output_dir = 'E:/SteroidXtract_2020/output' # output data path for SteroidXtract
model_dir = 'E:/SteroidXtract_2020/model' # data path for SteroidXtract models
...
pre_int_threshold = 1000  # precursor intensity threshold
                          # (MS2 with precursor intensities lower than the threshold are discarded)
