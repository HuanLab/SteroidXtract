...
pre_int_threshold = 500   # precursor intensity threshold
                          # (MS2 with precursor intensities in MS1 scans lower than the threshold are discarded)
